...
def collect_data():
    s = requests.Session()
    response = s.get(url="https://salomon.ru/catalog/muzhchiny/obuv/filter/available-is-y/size-is-10%20uk-or-10.5%20uk/apply/?PAGEN_1=2" , headers=headers)
    ...
    for page_count in range(1, pagination_count+1):
        url = f"https://salomon.ru/catalog/muzhchiny/obuv/filter/available-is-y/size-is-10%20uk-or-10.5%20uk/apply/?PAGEN_1={page_count}"
...
def main():
    # get_page(url="https://salomon.ru/catalog/muzhchiny/obuv/filter/available-is-y/apply/?sort=discount-desc")
    # get_json(url="https://salomon.ru/catalog/muzhchiny/obuv/filter/available-is-y/size-is-10%20uk-or-10.5%20uk/apply/?PAGEN_1=2")
    collect_data()
